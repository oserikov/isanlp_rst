...
RUN pip install setuptools==41.0.1 scipy scikit-learn==0.20.2 gensim==3.6.0 smart-open==1.7.0 tensorflow==1.12.0 keras==2.2.4 h5py tensorflow-hub pandas nltk imbalanced-learn catboost
